...
class _MiscellaneousEventsState extends State<MiscellaneousEvents> {
  static var _eventListMiscellaneousEvents = eventsList[3]; ////assigning Miscellaneous Events list
            ...
            child: Column(
                ...
                children: <Widget>[
                  InkWell(
                    child: Stack(
                      children: <Widget>[
                        PosterScrollWidget(_eventListMiscellaneousEvents, currentPage),
                        Positioned.fill(
                            child: PageView.builder(
                                //this PageView is basically a glorified GestureDetector.
                                itemCount: _eventListMiscellaneousEvents.length,
                  ...
                  Text(
                    _eventListMiscellaneousEvents[currentPage.round()]['eventName'],
