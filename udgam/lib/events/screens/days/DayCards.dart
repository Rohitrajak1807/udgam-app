...
// 
            ...
            var deltaFromCurrentPage = i - widget.currentPage; //should be positive if page is to the right, negative if to the left
                    ...
                    primaryPosterLeft //default left position for main poster
                        ...
                        hiddenPosterHorizontalInset //pages should shift to the left or right as they go "out of focus"
                            ...
                            *
                            (isOnRight
                                ? 40
                                : 1) /////////////////////pages should shift much more quickly when going to the right (off the top of the stack) than when going to the left
                    ,
            ...
            posters.add(Positioned.directional(
              // key: Key(url),
              top: padding +
                  hiddenPosterVerticalInset *
                      max(-deltaFromCurrentPage,
                          0.0), //posters to the left should become smaller,
